            ...
            <div class="modal-body">
                    ...
                    <div class="form-group basic">
                        <div class="input-wrapper">
                            ...
                            <input type="text" class="form-control" id="name" value="{{ auth()->guard('pegawai')->user()->name }}" readonly><i class="clear-input"><ion-icon name="close-circle" role="img" class="md hydrated" aria-label="close circle"></ion-icon></i>
                        </div>
                    </div>
                    <div class="form-group basic">
                        <div class="input-wrapper">
...
<script type="text/javascript">
    ...
    function printPage(){
        ...
        window.location.href = "/pegawai/history/print?tanggal_awal="+tanggalAwal+"&tanggal_akhir="+tanggalAkhir;
    }

                    ...
                    <form id="tambahIzin" autocomplete="off">
                        ...
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                ...
                                <input type="hidden" name="pegawai_id" value="{{ auth()->guard('pegawai')->user()->id }}">
                                <input type="hidden" name="opd_id" value="{{ auth()->guard('pegawai')->user()->opd->id }}">
                                <input type="text" class="form-control" name="name" value="{{ auth()->guard('pegawai')->user()->name }}"  readonly="" required=""><i class="clear-input"><ion-icon name="close-circle" role="img" class="md hydrated" aria-label="close circle"></ion-icon></i>
                            </div>
                        </div>
                    ...
                    <form id="form-update-cuty" autocomplete="off">
                        ...
                        <div class="form-group basic">
                            <div class="input-wrapper">
                                ...
                                <input type="text" class="form-control" id="name" value="{{ auth()->guard('pegawai')->user()->name }}" required=""><i class="clear-input"><ion-icon name="close-circle" role="img" class="md hydrated" aria-label="close circle"></ion-icon></i>
                            </div>
                        </div>
                        <div class="form-group">
